...
public class TwitterCaller {
    ...
    public void callFromUnity(final Context context, String text, String textureUrl, final String gameObjectName, final String callbackMethodName) {
        tweet(context, text, textureUrl, new Callback() {
            @Override
            public void onResult(int resultCode) {
    ...
    public void tweet(Context context, String text, String textureUrl, final Callback callback) {
        ...
        if(textureUrl != null) intent.putExtra(Intent.EXTRA_STREAM, textureUrl);
